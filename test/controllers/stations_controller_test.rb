...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { identifier: @station.identifier, name: @station.name, trip_id: @station.trip_id }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { identifier: @station.identifier, name: @station.name, trip_id: @station.trip_id }
    assert_redirected_to station_path(assigns(:station))
  end
